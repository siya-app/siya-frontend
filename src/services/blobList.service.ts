// src/assets/blobs/blob-manifest.ts
// import blob from '../assets/blobs/cover-blobs/EXAMPLE-BLOB.png'

// export const BLOB_CATEGORIES_LIST = {
//     cover: {
//         ceiling: import('../assets/blobs/cover-blobs/ceiling-blob.png'),
//         fullCover: import('.assets/blobs/cover-blobs/full-cover-blob.png'),
//         noCover: import('.assets/blobs/cover-blobs/no-cover-blob.png'),
//         umbrella: import('.assets/blobs/cover-blobs/umbrella-blob.png')
//     },
//     dietary: {
//         glutenFree: import('./dietary-rest-blobs/glutenFree-blob.png'),
//         vegan: import('./dietary-rest-blobs/vegan-blob.png'),
//         veggie: import('./dietary-rest-blobs/veggie-blob.png')
//     },
//     emotional: {
//         cozy: import('./emotional-blobs/cozy-blob.png'),
//         elegant: import('./emotional-blobs/elegant-blob.png'),
//         familyFriendly: import('./emotional-blobs/family-friendly-blob.png'),
//         friends: import('./emotional-blobs/friends-blob.png'),
//         groups: import('./emotional-blobs/groups-blob.png'),
//         lgtbiFriendly: import('./emotional-blobs/lgtbi-friendly-blob.png'),
//         lively: import('./emotional-blobs/lively-blob.png'),
//         petLovers: import('./emotional-blobs/petlovers-blob.png'),
//         relaxed: import('./emotional-blobs/relaxed-blob.png'),
//         romantic: import('./emotional-blobs/romantic-blob.png'),
//         silent: import('./emotional-blobs/silent-blob.png'),
//         trendy: import('./emotional-blobs/trendy-blob.png')
//     },
//     food: {
//         american: import('./food-blobs/american-blob.png'),
//         asian: import('./food-blobs/asian-blob.png'),
//         breakfast: import('./food-blobs/breakfast-blob.png'),
//         brunch: import('./food-blobs/brunch-blob.png'),
//         burger: import('./food-blobs/burger-blob.png'),
//         chicken: import('./food-blobs/chicken-blob.png'),
//         chinese: import('./food-blobs/chinese-blob.png'),
//         dailyMenu: import('./food-blobs/dailyMenu-blob.png'),
//         indian: import('./food-blobs/indian-blob.png'),
//         italian: import('./food-blobs/italian-blob.png'),
//         kebab: import('./food-blobs/kebab-blob.png'),
//         latin: import('./food-blobs/latin-blob.png'),
//         mex: import('./food-blobs/mex-blob.png'),
//         middleEast: import('./food-blobs/middleEast-blob.png'),
//         peruvian: import('./food-blobs/peruvian-blob.png'),
//         pizza: import('./food-blobs/pizza-blob.png'),
//         spanish: import('./food-blobs/spanish-food.png'),
//         tapas: import('./food-blobs/tapas-blob.png'),
//         thai: import('./food-blobs/thai-blob.png'),
//         viet: import('./food-blobs/viet-blob.png')
//     },
//     placement: {
//         nature: import('./placement-blobs/nature-blob.png'),
//         park: import('./placement-blobs/park-blob.png'),
//         rooftop: import('./placement-blobs/rooftop-blob.png'),
//         seaside: import('./placement-blobs/seaside-blob.png'),
//         square: import('./placement-blobs/square-blob.png'),
//         street: import('./placement-blobs/street-blob.png')
//     }
// } as const;
...
// import placeRootop from '../assets/blobs/placement-blobs/rooftop-blob.png';
